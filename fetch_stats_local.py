...
def fetch_server_stats(server_name):
    ...
    proc_query = "nvidia-smi --query-processes=gpu_uuid,pid,process_name,used_gpu_memory,elapsed_time --format=csv,noheader,nounits"    proc_output = run_local_command(proc_query)
    pid_to_gpu = {}
    pids_on_server = []
